...
public class TabMyPost extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.tabmypost, container, false);

        mRecyclerView = rootView.findViewById(R.id.recyclerViewIn);
